...
import { freeQuestionsAPI, type QuestionRequest, type QuestionResponse, type MockTestResponse } from '../services/api';
...
export default function FreeQuestions({ mockTest, onClose }: FreeQuestionsProps) {
  ...
  const loadQuestions = async () => {
    try {
      setLoading(true);
      const response = await freeQuestionsAPI.getByMockTest(mockTest.id);
  ...
  const confirmDelete = async () => {
    ...
    try {
      await freeQuestionsAPI.delete(deleteConfirm.questionId);
    ...
    <div className="modal-overlay">
      <div className="questions-modal">
        <div className="questions-header">
          <h2>🆓 Free Questions - {mockTest.name}</h2>
